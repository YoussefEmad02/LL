...
class CartQuantitySelectorComponent extends QuantitySelectorComponent {
  ...
  updateButtonStates() {
    ...
    const isDisabled = this.refs.quantityInput.disabled;
    minusButton.disabled = isDisabled || value <= min;
    plusButton.disabled = isDisabled || (effectiveMax !== null && value >= effectiveMax);
  }
}
